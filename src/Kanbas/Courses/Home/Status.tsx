...
import { BsHouse, BsMegaphone, BsBarChart, BsBell } from "react-icons/bs";
...
export default function CourseStatus() {
  ...
  return (
    <div id="wd-course-status" style={{ width: "300px" }}>
      ...
      {/* Render Publish/Unpublish buttons only for FACULTY users */}
      ...
      {/* Additional buttons available to all users */}
